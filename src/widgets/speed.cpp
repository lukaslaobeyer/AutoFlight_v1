...
void Speed::navdataAvailable(std::shared_ptr<const drone::navdata> nd)
{
	float speed = sqrt(nd->linearvelocity(0) * nd->linearvelocity(0) + nd->linearvelocity(1) * nd->linearvelocity(1));
